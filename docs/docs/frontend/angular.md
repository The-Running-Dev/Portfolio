...
## [BarStrad](https://github.com/The-Running-Dev/BarStrad-UI)

**Updated**: February 9, 2025 @ 23:05

Angular based menu application, with theming, language support, orders, and Discord notifications. Proof of concept.

## [Manual Tests](https://github.com/The-Running-Dev/Contec-ManualTests)

**Updated**: April 16, 2019 @ 23:57

A line of business application for recording manually tested equipment. 
