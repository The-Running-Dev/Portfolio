...
export function useFeaturesConfig(): FeaturesConfig {
  return useMemo(() => {
    try {
      ...
      console.error("Failed to Load or Validate Features Configuration:", error);
...
export function useFeatureFlag<T extends keyof FeaturesConfig>(feature: T): boolean;

// Implementation
export function useFeatureFlag(feature: Features | keyof FeaturesConfig): boolean {
