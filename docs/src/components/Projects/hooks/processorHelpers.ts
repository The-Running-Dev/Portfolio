 ...
 */
export function generateDateOptions(categories: ProcessedCategory[]): FilterOption[] {
 ...
 */
export function generateTagOptions(categories: ProcessedCategory[]): FilterOption[] {
