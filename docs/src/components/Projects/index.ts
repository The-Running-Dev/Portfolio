...
export { default as StaticProjects } from './StaticProjects';
export { default as HttpProjects } from './HttpProjects';
export {
  ProjectsWithStaticData,
  ProjectsWithApiData,
  ProjectsWithCustomApi,
  ProjectsWithEnvironmentBasedData
} from './ProjectsExamples';
